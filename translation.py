class Translation(object):
    START_TEXT = """Immortal Download Bot"""
    RENAME_403_ERR = "Sorry. You are not permitted to rename this file."
    ABS_TEXT = " Please don't be selfish."
    UPGRADE_TEXT = "This bot is free to use if u r Binary friend"
...
URL | filename | username | password"""
    ...
    RCHD_BOT_API_LIMIT = "Size is very big. Neverthless, trying to upload."
